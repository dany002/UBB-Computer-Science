...
Controller::Controller(const Repository& repo, const WatchList& watch_list) {
    /*
     * It creates a controller using as parameters the repository and the watch list.
     */
    this->repo = repo;
...
int Controller::get_size_watch_list() {
    /*
