...
void UI::print_movies_admin() {
    for(int i = 0; i < this->control.get_size(); i++){
        std::cout << "Title: " << this->control.get_movies()[i].get_title() << "    ";
        std::cout << "Genre: " << this->control.get_movies()[i].get_genre() << "    ";
        std::cout << "Year of release: " << this->control.get_movies()[i].get_year_of_release() << "\n";
        std::cout << "Number of likes: " << this->control.get_movies()[i].get_number_of_likes() << "    ";
        std::cout << "Trailer: " << this->control.get_movies()[i].get_trailer() << '\n';
        std::cout << "\n";
    }
}
...
void UI::watch_movie() {
    ...
    if(!this->control.check_movie_in_watch_list(title)){
         std::cout << "The movie doesnt exist.\n";
         run_command_for_user();
    }
...
void UI::see_movies_from_watch_list() {
    for(int i = 0; i < this->control.get_size_watch_list(); i++){
        std::cout << "Title: " << this->control.get_all_movies_from_wl()[i].get_title() << "    ";
        std::cout << "Genre: " << this->control.get_all_movies_from_wl()[i].get_genre() << "    ";
        std::cout << "Year of release: " << this->control.get_all_movies_from_wl()[i].get_year_of_release() << "\n";
        std::cout << "Number of likes: " << this->control.get_all_movies_from_wl()[i].get_number_of_likes() << "    ";
        std::cout << "Trailer: " << this->control.get_all_movies_from_wl()[i].get_trailer() << '\n';
        std::cout << "\n";
    }
}
