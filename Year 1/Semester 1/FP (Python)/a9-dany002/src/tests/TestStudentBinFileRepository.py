...
class TestStudentBinFileRepository(unittest.TestCase):

    def setUp(self) -> None:
        file_name = "students_bin_test"
        self.__student_repository = StudentBinFileRepository(file_name)

    def tearDown(self) -> None:
        if os.path.exists("students_bin_test"):
            os.remove("students_bin_test")
    """
        TESTS FOR ADD
    """
