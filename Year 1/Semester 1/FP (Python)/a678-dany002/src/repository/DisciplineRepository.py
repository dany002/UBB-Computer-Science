...
class DisciplineRepository:
    ...
    def add_a_discipline(self, discipline_that_is_going_to_be_added):
        ...
        for index in range(len(self.__disciplines)):
            if self.__disciplines[index].discipline_id == discipline_that_is_going_to_be_added.discipline_id:
                raise RepositoryException("Discipline ID is already taken.")
        self.__disciplines.append(discipline_that_is_going_to_be_added)
    ...
    def remove_a_discipline(self, discipline_id):
        ...
        found_id = False
        for index in range(len(self.__disciplines)):
            if self.__disciplines[index].discipline_id == discipline_id:
                found_id = True
        if found_id == False:
        ...
        index = 0
        length = len(self.__disciplines)
        while index < length:
            if int(self.__disciplines[index].discipline_id) == int(discipline_id):
                del self.__disciplines[index]
                index -= 1
                length -= 1
            index += 1
    ...
    def search_a_discipline_by_discipline_ID(self, discipline_id):
        ...
        for index in range(len(self.__disciplines)):
            if int(self.__disciplines[index].discipline_id) == int(discipline_id):
                discipline = self.__disciplines[index]
    ...
    def search_a_discipline_by_name(self, discipline_name):
        ...
        result_list_with_searched_discipline = []
        for index in range(len(self.__disciplines)):
            if self.__disciplines[index].name == discipline_name:
                discipline = {'id': self.__disciplines[index].discipline_id, 'name': self.__disciplines[index].name}
                result_list_with_searched_discipline.append(discipline)
        if result_list_with_searched_discipline == []:
    ...
    def update_a_discipline_by_name(self, discipline_name, new_discipline_id):
        ...
        """
        for index in range(len(self.__disciplines)):
            if self.__disciplines[index].discipline_id == int(new_discipline_id):
                raise RepositoryException("Discipline ID is already taken.")
        name_found = False

        for index in range(len(self.__disciplines)):
            if self.__disciplines[index].name == discipline_name:
                self.__disciplines[index].discipline_id = new_discipline_id
                name_found = True
        if name_found == False:
    ...
    def update_a_discipline_by_id(self, discipline_id, new_discipline_name):
        ...
        for index in range(len(self.__disciplines)):
            if int(self.__disciplines[index].discipline_id) == int(discipline_id):
                self.__disciplines[index].name = new_discipline_name
                id_found = True
        if id_found == False:
