...
class StudentsService:
    ...
    def search_a_student_by_name(self, student_name):
        ...
        :return: list.
        """
        the_list_of_students_that_match_the_given_name = []
        for students in self.__repository.list_of_students():
            if students.name.lower().find(student_name.lower()) != -1:
                the_list_of_students_that_match_the_given_name.append(students)
        return the_list_of_students_that_match_the_given_name
