...
public class MainWindowController {
    ...
    @FXML
    private TableView<Pair<Integer,Integer>> semaphoreTableTableView;

    @FXML
    private TableColumn<Pair<Integer,Integer>,Integer> sempahoreIndexColumn;

    @FXML
    private TableColumn<Pair<Integer,Integer>,Integer> semaphoreValueColumn;

    @FXML
    private TableColumn<Pair<Integer,Integer>,Integer> semaphoreListOfValues;
