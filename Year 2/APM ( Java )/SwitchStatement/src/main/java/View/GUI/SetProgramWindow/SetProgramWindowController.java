...
public class SetProgramWindowController {
    ...
    public void initialize(){
        List<IStatement> hardcodedPrograms = new ArrayList<IStatement>(List.of(
                ...
                new CompositeStatement(new VariableDeclarationStatement("a",new IntegerType()), new CompositeStatement(new AssignmentStatement("a",new ConstantExpression(new IntegerValue(1))),new CompositeStatement(new VariableDeclarationStatement("b",new IntegerType()),new CompositeStatement(new AssignmentStatement("b",new ConstantExpression(new IntegerValue(2))),new CompositeStatement(new VariableDeclarationStatement("c",new IntegerType()),new CompositeStatement(new AssignmentStatement("c", new ConstantExpression(new IntegerValue(5))),new CompositeStatement(new SwitchStatement(new BinaryExpression(new VariableExpression("a"),new ConstantExpression(new IntegerValue(10)),"*"),new BinaryExpression(new VariableExpression("b"),new VariableExpression("c"),"*"),new CompositeStatement(new PrintStatement(new VariableExpression("a")),new PrintStatement(new VariableExpression("b"))),new ConstantExpression(new IntegerValue(10)),new CompositeStatement(new PrintStatement(new ConstantExpression(new IntegerValue(100))),new PrintStatement(new ConstantExpression(new IntegerValue(200)))),new PrintStatement(new ConstantExpression(new IntegerValue(300)))),new PrintStatement(new ConstantExpression(new IntegerValue(300))))))))))
        ));
