...
public class SetProgramWindowController {
    ...
    public void initialize(){
        List<IStatement> hardcodedPrograms = new ArrayList<IStatement>(List.of(
                ...
                new CompositeStatement(new VariableDeclarationStatement("v",new IntegerType()),new CompositeStatement(new AssignmentStatement("v",new ConstantExpression(new IntegerValue(20))),new CompositeStatement(new ForStatement(new AssignmentStatement("v", new ConstantExpression(new IntegerValue(0))), new BinaryExpression(new VariableExpression("v"),new ConstantExpression(new IntegerValue(3)),"<"),new AssignmentStatement("v", new BinaryExpression(new VariableExpression("v"), new ConstantExpression(new IntegerValue(1)),"+")),new ForkStatement(new CompositeStatement(new PrintStatement(new VariableExpression("v")),new AssignmentStatement("v", new BinaryExpression(new VariableExpression("v"), new ConstantExpression(new IntegerValue(1)),"+"))))),new PrintStatement(new BinaryExpression(new VariableExpression("v"),new ConstantExpression(new IntegerValue(10)),"*"))))),
                new CompositeStatement(new VariableDeclarationStatement("v",new IntegerType()),new CompositeStatement(new AssignmentStatement("v",new ConstantExpression(new IntegerValue(0))),new CompositeStatement(new RepeatStatement(new CompositeStatement(new ForkStatement(new CompositeStatement(new PrintStatement(new VariableExpression("v")),new AssignmentStatement("v",new BinaryExpression(new VariableExpression("v"),new ConstantExpression(new IntegerValue(1)),"-")))),new AssignmentStatement("v",new BinaryExpression(new VariableExpression("v"),new ConstantExpression(new IntegerValue(1)),"+"))), new BinaryExpression(new VariableExpression("v"), new ConstantExpression(new IntegerValue(3)),"==")),new CompositeStatement(new VariableDeclarationStatement("x", new IntegerType()),new CompositeStatement(new AssignmentStatement("x",new ConstantExpression(new IntegerValue(1))), new CompositeStatement(new VariableDeclarationStatement("y",new IntegerType()),new CompositeStatement(new AssignmentStatement("y",new ConstantExpression(new IntegerValue(2))),new CompositeStatement(new VariableDeclarationStatement("z",new IntegerType()),new CompositeStatement(new AssignmentStatement("z",new ConstantExpression(new IntegerValue(3))),new CompositeStatement(new VariableDeclarationStatement("w",new IntegerType()),new CompositeStatement(new AssignmentStatement("w", new ConstantExpression(new IntegerValue(4))), new PrintStatement(new BinaryExpression(new VariableExpression("v"),new ConstantExpression(new IntegerValue(10)),"*")))))))))))))
                ));
