...
public class SetProgramWindowController {
    ...
    public void initialize(){
        List<IStatement> hardcodedPrograms = new ArrayList<IStatement>(List.of(
                ...
                new CompositeStatement(new VariableDeclarationStatement("b",new BooleanType()),new CompositeStatement(new VariableDeclarationStatement("c",new IntegerType()),new CompositeStatement(new AssignmentStatement("b",new ConstantExpression(new BooleanValue(true))),new CompositeStatement(new ConditionalAssignmentStatement("c",new VariableExpression("b"),new ConstantExpression(new IntegerValue(100)),new ConstantExpression(new IntegerValue(200))),new CompositeStatement(new PrintStatement(new VariableExpression("c")),new CompositeStatement(new ConditionalAssignmentStatement("c", new ConstantExpression(new BooleanValue(false)),new ConstantExpression(new IntegerValue(100)),new ConstantExpression(new IntegerValue(200))),new PrintStatement(new VariableExpression("c"))))))))
                ));
