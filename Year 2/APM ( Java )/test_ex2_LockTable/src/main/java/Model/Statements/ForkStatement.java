...
public class ForkStatement implements IStatement{
    ...
    public ProgState execute(ProgState progState) throws AppException {
        return new ProgState(new ExecutionStack(), progState.getSymTable().copy(), progState.getOutput(), progState.getFileTable(), progState.getHeap(), progState.getLockTable(), this.innerStatement);
    }
