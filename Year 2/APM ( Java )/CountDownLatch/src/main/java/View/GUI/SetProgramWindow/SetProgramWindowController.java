    ...
    public void initialize(){
        List<IStatement> hardcodedPrograms = new ArrayList<IStatement>(List.of(
                ...
                new CompositeStatement(new VariableDeclarationStatement("v1",new RefType(new IntegerType())),
                        new CompositeStatement(new NewStatement("v1", new ConstantExpression(new IntegerValue(2))),
                                new CompositeStatement(new VariableDeclarationStatement("v2",new RefType(new IntegerType())),
                                        new CompositeStatement(new NewStatement("v2",new ConstantExpression(new IntegerValue(3))),
                                                new CompositeStatement(new VariableDeclarationStatement("v3",new RefType(new IntegerType())),
                                                        new CompositeStatement(new NewStatement("v3",new ConstantExpression(new IntegerValue(4))),
                                                                new CompositeStatement(new VariableDeclarationStatement("cnt",new IntegerType()),
                                                                        new CompositeStatement(new NewLatchStatement("cnt",new ReadHeapExpression(new VariableExpression("v2"))),
                                                                                new CompositeStatement(new ForkStatement(new WriteHeapStatement(new VariableExpression("v1"),new BinaryExpression(new ReadHeapExpression(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(10)),"*"))),
                                                                                        new CompositeStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                                                                                                new CompositeStatement(new CountDownStatement("cnt"),
                                                                                                        new CompositeStatement(new ForkStatement(new WriteHeapStatement(new VariableExpression("v2"),new BinaryExpression(new ReadHeapExpression(new VariableExpression("v2")),new ConstantExpression(new IntegerValue(10)),"*"))),
                                                                                                                new CompositeStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v2"))),
                                                                                                                        new CompositeStatement(new CountDownStatement("cnt"),
                                                                                                                                new CompositeStatement(new ForkStatement(new WriteHeapStatement(new VariableExpression("v3"), new BinaryExpression(new ReadHeapExpression(new VariableExpression("v3")),new ConstantExpression(new IntegerValue(10)),"*"))),
                                                                                                                                        new CompositeStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v3"))),
                                                                                                                                                new CompositeStatement(new CountDownStatement("cnt"),
                                                                                                                                                        new CompositeStatement(new AwaitStatement("cnt"),
                                                                                                                                                                new CompositeStatement(new PrintStatement(new ConstantExpression(new IntegerValue(100))),
                                                                                                                                                                        new CompositeStatement(new CountDownStatement("cnt"),
