...
public class SetProgramWindowController {
    ...
    public void initialize(){
        List<IStatement> hardcodedPrograms = new ArrayList<IStatement>(List.of(
                ...
                new CompositeStatement(new VariableDeclarationStatement("v1",new IntegerType()), new CompositeStatement(new AssignmentStatement("v1", new ConstantExpression(new IntegerValue(2))),new CompositeStatement(new VariableDeclarationStatement("v2", new IntegerType()), new CompositeStatement(new AssignmentStatement("v2", new ConstantExpression(new IntegerValue(3))), new IfStatement(new BinaryExpression(new VariableExpression("v1"),new ConstantExpression(new IntegerValue(0)),"!="), new PrintStatement(new MulExpression(new VariableExpression("v1"), new VariableExpression("v2"))),new PrintStatement(new VariableExpression("v1")))))))
                ));
