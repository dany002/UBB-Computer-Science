...
public class SetProgramWindowController {
    ...
    public void initialize(){
        List<IStatement> hardcodedPrograms = new ArrayList<IStatement>(List.of(
                ...
                new CompositeStatement(new VariableDeclarationStatement("v1",new RefType(new IntegerType())),
                        new CompositeStatement(new VariableDeclarationStatement("v2",new RefType(new IntegerType())),
                        new CompositeStatement(new VariableDeclarationStatement("x",new IntegerType()),
                                new CompositeStatement(new VariableDeclarationStatement("q",new IntegerType()),
                                        new CompositeStatement(new NewStatement("v1",new ConstantExpression(new IntegerValue(20))),
                                        new CompositeStatement(new NewStatement("v2",new ConstantExpression(new IntegerValue(30))),
                                        new CompositeStatement(new NewLockStatement(new VariableExpression("x")),
                                        new CompositeStatement(new ForkStatement(
                                                new CompositeStatement(new ForkStatement(new CompositeStatement(
                                                        new LockStatement(new VariableExpression("x")),
                                                        new CompositeStatement(new WriteHeapStatement(new VariableExpression("v1"), new BinaryExpression(new ReadHeapExpression(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(1)),"-")),
                                                                new UnlockStatement(new VariableExpression("x"))))),
                                                        new CompositeStatement(new LockStatement(new VariableExpression("x")),
                                                                new CompositeStatement(new WriteHeapStatement(new VariableExpression("v1"),new BinaryExpression(new ReadHeapExpression(new VariableExpression("v2")),new ConstantExpression(new IntegerValue(5)),"+")),
                                                                        new UnlockStatement(new VariableExpression("x")))))),
                                                        new CompositeStatement(new NewLockStatement(new VariableExpression("q")),
                                                                new CompositeStatement(new ForkStatement(new CompositeStatement(new ForkStatement(new CompositeStatement(new LockStatement(new VariableExpression("q")),
                                                                        new CompositeStatement(new WriteHeapStatement(new VariableExpression("v2"),new BinaryExpression(new ReadHeapExpression(new VariableExpression("v2")),new ConstantExpression(new IntegerValue(5)),"+")),
                                                                                new UnlockStatement(new VariableExpression("q"))))),
                                                                        new CompositeStatement(new LockStatement(new VariableExpression("q")),
                                                                                new CompositeStatement(new WriteHeapStatement(new VariableExpression("v2"),new BinaryExpression(new ReadHeapExpression(new VariableExpression("v2")),new ConstantExpression(new IntegerValue(10)),"*")),
                                                                                        new LockStatement(new VariableExpression("q")))))),
                                                                new CompositeStatement(new NoOperationStatement(),
                                                                        new CompositeStatement(new NoOperationStatement(),
                                                                                new CompositeStatement(new NoOperationStatement(),
                                                                                        new CompositeStatement(new NoOperationStatement(),
                                                                                                new CompositeStatement(new LockStatement(new VariableExpression("x")),
                                                                                                        new CompositeStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                                                                                                                new CompositeStatement(new UnlockStatement(new VariableExpression("x")),
                                                                                                                        new CompositeStatement(new LockStatement(new VariableExpression("q")),
                                                                                                                                new CompositeStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v2"))),
                                                                                                                                        new UnlockStatement(new VariableExpression("q")))))))))))))
