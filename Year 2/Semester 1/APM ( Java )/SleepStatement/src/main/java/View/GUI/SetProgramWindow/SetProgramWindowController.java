...
public class SetProgramWindowController {
    ...
    public void initialize(){
        List<IStatement> hardcodedPrograms = new ArrayList<IStatement>(List.of(
                ...
                new CompositeStatement(new VariableDeclarationStatement("v", new IntegerType()), new CompositeStatement(new AssignmentStatement("v", new ConstantExpression(new IntegerValue(0))), new CompositeStatement(new WhileStatement(new BinaryExpression(new VariableExpression("v"), new ConstantExpression(new IntegerValue(3)),"<"),new CompositeStatement(new ForkStatement(new CompositeStatement(new PrintStatement(new VariableExpression("v")),new AssignmentStatement("v", new BinaryExpression(new VariableExpression("v"),new ConstantExpression(new IntegerValue(1)),"+")))),new AssignmentStatement("v", new BinaryExpression(new VariableExpression("v"), new ConstantExpression(new IntegerValue(1)),"+")))) ,new CompositeStatement(new SleepStatement(new ConstantExpression(new IntegerValue(5))),new PrintStatement(new BinaryExpression(new VariableExpression("v"), new ConstantExpression(new IntegerValue(10)), "*"))))))
        ));
