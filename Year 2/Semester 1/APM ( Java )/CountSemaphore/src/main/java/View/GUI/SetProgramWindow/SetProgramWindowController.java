                ...
                new CompositeStatement(new VariableDeclarationStatement("v1",new RefType(new IntegerType())),
                        new CompositeStatement(new VariableDeclarationStatement("cnt",new IntegerType()),
                                new CompositeStatement(new NewStatement("v1",new ConstantExpression(new IntegerValue(1))),
                                        new CompositeStatement(new CreateSemaphoreStatement(new VariableExpression("cnt"),new ReadHeapExpression(new VariableExpression("v1"))),
                                                new CompositeStatement(new ForkStatement(
                                                        new CompositeStatement(new AcquireStatement(new VariableExpression("cnt")),
                                                                new CompositeStatement(new WriteHeapStatement(new VariableExpression("v1"),new BinaryExpression(new ReadHeapExpression(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(10)),"*")),
                                                        ...
                                                        new CompositeStatement(new AcquireStatement(new VariableExpression("cnt")),
                                                                new CompositeStatement(new WriteHeapStatement(new VariableExpression("v1"),new BinaryExpression(new ReadHeapExpression(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(10)),"*")),
                                                                        new CompositeStatement(new WriteHeapStatement(new VariableExpression("v1"),new BinaryExpression(new ReadHeapExpression(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(2)),"*")),
                                                                                new CompositeStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                                                                                new ReleaseStatement(new VariableExpression("cnt"))))))),
                                                        new CompositeStatement(new AcquireStatement(new VariableExpression("cnt")),
                                                                new CompositeStatement(new PrintStatement(new BinaryExpression(new ReadHeapExpression(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(1)),"-")),
                                                                        new ReleaseStatement(new VariableExpression("cnt"))))
                                                ))))))
        ));
